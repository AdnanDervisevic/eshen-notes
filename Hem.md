...
graph TD
    HH[Havets Hämnare]
    VB[Victoria Bell] --> HH
    HH -->|allierade| EDGAR[Edgar]
    HH -->|fiender| HAGS[Häxornas systerskap]
    HAGS --- AGATHA[Agatha] & ETHEL[Ethel död] & LUELLA[Luella död]
    HAGS -.->|äldre coven| NANA[Nana Twignose]
    HH -->|komplicerad| AMRAI[Amrai]
    AMRAI -->|älskade| PATIENCE[Patience]
    PATIENCE -->|älskar| AURON[Auron]
    AMRAI -.->|Court of Stars?| FEY[Feywild]
    HH -->|tjänar| KRONAN[Hus Maxwell]
    ARON[Victor Aronian] -->|attackerade| KRONAN
    ARON -->|far till| IVAN[Ivan Vargöga]
    OLIVER[Oliver] -->|själskontrakt| LEV[Levistus]
    SIGURTH[Sigurth] -->|celestial| ODEN[Oden/Valhalla]
    ESTALFUS[Estalfus] -->|paladin| TORM[Torm]
    HH --> OLIVER & SIGURTH & ESTALFUS
```
